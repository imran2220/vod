  ...
  <div class="container_12"> 
    ...
    <div class="page-title grid_12">
      <div class="title" dir="rtl">
        <h1> العروض المجانية </h1>
      </div>
      <ul class="breadcrumbs">
        <li><a  class="home" href="http://www.3at3oot.tv/">الصفحة الرئيسية</a></li>
        <li>/</li>
        <li><span class="active"> العروض المجانية </span></li>
      </ul>
    </div>
    <!-- .page-title end --> 
  </div>
...
<section id="content-wrapper">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
         ...
         <iframe src="//player.vimeo.com/video/76382235" width="930" height="365" align="middle" style="margin-top:10px; margin-right:5px;"> </iframe><br><br>
        </section>
        <!-- blog-info end --> 
